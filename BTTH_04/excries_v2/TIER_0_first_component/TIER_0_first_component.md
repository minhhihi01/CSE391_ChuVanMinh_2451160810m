...
Mục tiêu: Viết thành phần React đầu tiên, hiểu luồng hoạt động cơ bản
Không cần biết: useState, events, props — chỉ cần biết cơ bản HTML/JS
...
✅ Danh sách kiểm tra
Create project React Running
Tệp tin .jsxlà...
Viết được cơ bản thành phần
Biết class→ className, for→htmlFor
Biết phải đóng tất cả các thẻ ( <img />, <input />)
🎯 Tổng kết
React Component = Function trả về JSX
JSX = HTML với vài khác biệt nhỏ (className, htmlFor, đóng thẻ)
→ Tiếp theo: Tier 1 — Hiểu Stream React